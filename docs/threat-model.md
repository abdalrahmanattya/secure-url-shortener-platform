...
| Supply-chain compromise | Locked runtime dependencies, multi-platform pinned image digests, non-root image, local Trivy scan with 0 HIGH/CRITICAL, and hosted SBOM upload verified in CI run `31580237125` | Image provenance/signing and ongoing dependency updates require continued review. |
